...
export const routes: RouteDefinition[] = [
  ...
  },
  {
    ...
    description: 'Specialized route focusing on leg attack sequences',
    difficulty: 'advanced',
    startPosition: 'striking-offense-5',
    endPositions: ['attack-primary-5', 'attack-secondary-5', 'leglock-offense-5'],
    positions: [
      {
        id: 'striking-offense-5',
        name: 'Striking Offense',
        type: 'striking',
        description: 'Setup for leg attack entries',
        keyPoints: ['Low entries', 'Timing'],
        commonMistakes: ['High stance'],
      ...
      },
      {
        ...
        name: 'Takedown Offense',
        type: 'takedown',
        description: 'Takedown with leg focus',
        keyPoints: ['Leg access'],
        commonMistakes: ['High control'],
        coordinates: { x: 250, y: 700 },
        transitions: [
          {
            id: 'takedown-to-guard-5',
            target: 'guard-top-5',
            method: 'Guard with leg access',
            difficulty: 3
          }
        ]
      },
      {
        ...
        name: 'Guard Top',
        type: 'guard',
        description: 'Guard position for leg attacks',
        keyPoints: ['Leg isolation'],
        commonMistakes: ['Upper body focus'],
      ...
      },
      {
        ...
        name: 'Leglock Offense',
        type: 'leglock',
        description: 'Primary leg attack position',
        keyPoints: ['Control structure', 'Multiple attacks'],
        commonMistakes: ['Single attack focus'],
        coordinates: { x: 550, y: 700 },
        transitions: [
          {
            id: 'leglock-to-primary-5',
            target: 'attack-primary-5',
            method: 'Primary attack',
            difficulty: 4
          },
          {
            id: 'leglock-to-secondary-5',
            target: 'attack-secondary-5',
            method: 'Secondary attack',
            difficulty: 5
          },
          {
            id: 'leglock-to-supplemental-5',
            target: 'attack-supplemental-5',
            method: 'Supplemental attack',
            difficulty: 5
          }
        ]
      },
      {
        ...
        name: 'Primary',
        type: 'leglock',
        description: 'Primary leg submission',
        keyPoints: ['Finish efficiently'],
        commonMistakes: ['Poor timing'],
        coordinates: { x: 750, y: 650 },
        transitions: []
      },
      {
        id: 'attack-secondary-5',
        name: 'Secondary',
        type: 'leglock',
        description: 'Secondary leg attack',
        keyPoints: ['Chain attacks'],
        commonMistakes: ['Isolated attempts'],
        coordinates: { x: 750, y: 700 },
        transitions: []
      },
      {
        id: 'attack-supplemental-5',
        name: 'Supplemental',
        type: 'leglock',
        description: 'Supplemental attack option',
        keyPoints: ['Flow between attacks'],
        commonMistakes: ['Rigid sequences'],
    ...
    connections: [
      ...
      {
        id: 'conn-leglock-primary-5',
        from: 'leglock-offense-5',
        to: 'attack-primary-5',
        type: 'branch',
        method: 'Primary attack',
        difficulty: 4,
      ...
      {
        id: 'conn-leglock-secondary-5',
        from: 'leglock-offense-5',
        to: 'attack-secondary-5',
        type: 'primary',
        method: 'Secondary attack',
        difficulty: 5
      },
      {
        id: 'conn-leglock-supplemental-5',
        from: 'leglock-offense-5',
        to: 'attack-supplemental-5',
        type: 'branch',
        method: 'Supplemental attack',
        difficulty: 5,
        pathType: 'cubic-bezier'
    ...
    metadata: {
      estimatedTime: 40,
      prerequisites: ['Leg lock fundamentals', 'Guard retention'],
      tags: ['advanced', 'leg-attacks', 'submissions']
    }
  }
]
